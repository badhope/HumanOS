...
import ShortcutInitializer from './components/utils/ShortcutInitializer'
import { ToastProvider } from './components/ui/Toast'
import { ShortcutProvider } from './components/utils/ShortcutProvider'

import AppLayout from './components/layout/AppLayout'
import HomePage from './pages/core/HomePage'
import Daily from './pages/core/Daily'
...
import Progress from './pages/core/Progress'
...
import TheoryDetail from './pages/knowledge/TheoryDetail'
import PhilosophyHistoryPage from './pages/history/PhilosophyHistoryPage'
import PsychologyHistoryPage from './pages/history/PsychologyHistoryPage'
import IdeologyHistoryPage from './pages/history/IdeologyHistoryPage'
import IsmsPage from './pages/history/IsmsPage'
import PlatformStoryPage from './pages/history/PlatformStoryPage'
import OnePieceModeSelect from './pages/OnePieceModeSelect'
import Leaderboard from './pages/discovery/Leaderboard'
import SoulMatch from './pages/discovery/SoulMatch'
import Profile from './pages/Profile'
import NotFound from './pages/NotFound'
import ChartShowcase from './pages/knowledge/ChartShowcase'
import ModeSelect from './pages/ModeSelect'
import Discover from './pages/core/Discover'
import Training from './pages/core/Training'
